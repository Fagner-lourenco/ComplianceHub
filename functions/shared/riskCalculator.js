...
// =============================================================================
// SYNC: Este arquivo é a fonte de verdade do cálculo de risco.
// Deve ser mantido idêntico a src/core/riskCalculator.js (exceto module.exports vs export).
// Qualquer alteração aqui DEVE ser espelhada no arquivo frontend correspondente.
// =============================================================================

const LEGACY_PHASES = ['criminal', 'labor', 'warrant', 'osint', 'social', 'digital', 'conflictInterest'];
...
module.exports = { calculateRisk, LEGACY_PHASES, BASE_SCORES };
