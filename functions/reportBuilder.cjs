/* Report builder — server-side CommonJS mirror of src/core/reportBuilder.js
   Generates standalone HTML for public reports from canonical case data.
...
function socialLinkHtml(href, label, icon) {
    ...
    return `<a href="${esc(url)}" class="slink" target="_blank" rel="noopener noreferrer">${esc(icon)} ${esc(label)}</a>`;
}
...
function buildCaseBody(c, generatedAt) {
    ...
    const sLinks = [
        socialLinkHtml(sp.linkedin||c.linkedin,'LinkedIn','💼'),
        socialLinkHtml(sp.instagram||c.instagram,'Instagram','📸'),
        socialLinkHtml(sp.facebook||c.facebook,'Facebook','👤'),
...
const REPORT_CSS = `*{box-sizing:border-box;margin:0;padding:0}body{font-family:Inter,system-ui,-apple-system,BlinkMacSystemFont,sans-serif;color:#1e293b;background:#f0f2f5;font-size:13px;line-height:1.6}.page{max-width:820px;margin:0 auto;background:#fff;padding:40px 48px}.hdr{display:flex;justify-content:space-between;align-items:flex-start;padding-bottom:16px;border-bottom:3px solid #4f46e5;margin-bottom:28px}.hdr__brand{font-size:20px;font-weight:800;color:#4f46e5;letter-spacing:-.4px}.hdr__sub{font-size:11px;color:#64748b;margin-top:2px}.hdr__right{text-align:right;font-size:11px;color:#64748b;line-height:1.9}.hdr__tenant{font-weight:600;color:#1e293b;font-size:12px}.sec{margin-bottom:22px}.sec__t{font-size:9px;font-weight:700;text-transform:uppercase;letter-spacing:1.2px;color:#94a3b8;margin-bottom:10px;padding-bottom:5px;border-bottom:1px solid #f1f5f9}.fgrid{display:grid;grid-template-columns:repeat(3,1fr);gap:10px 20px}.f__l{font-size:9px;font-weight:700;color:#94a3b8;text-transform:uppercase;letter-spacing:.5px}.f__v{font-size:12px;color:#1e293b;margin-top:2px;font-weight:500;word-break:break-word}.rbox{background:linear-gradient(135deg,#f8fafc 0%,#f0f4ff 100%);border-radius:10px;padding:18px 24px;display:flex;align-items:center;gap:0;border:1px solid #e2e8f0}.rbox__score{flex:1;min-width:160px}.rbox__sl{font-size:9px;font-weight:700;color:#94a3b8;text-transform:uppercase;letter-spacing:.8px;margin-bottom:8px}.rbox__bw{display:flex;align-items:center;gap:12px}.rbox__bar{flex:1;height:10px;background:#e2e8f0;border-radius:99px;overflow:hidden;max-width:140px}.rbox__fill{height:100%;border-radius:99px}.rbox__num{font-size:28px;font-weight:800;color:#1e293b;line-height:1}.rbox__den{font-size:13px;font-weight:400;color:#94a3b8}.rbox__div{width:1px;background:#e2e8f0;align-self:stretch;margin:0 24px}.rbox__pg{display:flex;flex-direction:column;align-items:flex-start;gap:6px}.rbox__pl{font-size:9px;font-weight:700;color:#94a3b8;text-transform:uppercase;letter-spacing:.8px}.b{display:inline-flex;align-items:center;padding:3px 10px;border-radius:5px;font-size:11px;font-weight:600;line-height:1.5}.b--lg{padding:6px 14px;font-size:13px;font-weight:700;border-radius:6px}.b--green{background:#dcfce7;color:#15803d}.b--yellow{background:#fef9c3;color:#a16207}.b--red{background:#fee2e2;color:#b91c1c}.b--gray{background:#f1f5f9;color:#475569}.plist{display:flex;flex-direction:column;gap:10px}.pr{border:1px solid #e2e8f0;border-left:4px solid;border-radius:8px;padding:14px 18px;page-break-inside:avoid}.pr--red{border-left-color:#ef4444}.pr--yellow{border-left-color:#f59e0b}.pr--green{border-left-color:#22c55e}.pr--gray{border-left-color:#94a3b8}.pr__top{display:flex;justify-content:space-between;align-items:center}.pr__left{display:flex;align-items:center;gap:7px}.pr__icon{font-size:14px;line-height:1}.pr__name{font-size:11px;font-weight:700;color:#475569;text-transform:uppercase;letter-spacing:.6px}.pr__sev{margin-top:8px;padding-top:8px;border-top:1px solid #f1f5f9;display:flex;align-items:center;gap:6px}.pr__sev-label{font-size:10px;font-weight:600;color:#94a3b8}.pr__notes{margin-top:10px;padding-top:10px;border-top:1px solid #f1f5f9;font-size:12px;color:#374151;line-height:1.75;white-space:pre-wrap}.pr__tags{display:flex;flex-wrap:wrap;gap:5px;margin-top:8px}.tag{background:#f1f5f9;color:#475569;padding:2px 8px;border-radius:4px;font-size:10px;font-weight:500}.slinks{display:flex;flex-wrap:wrap;gap:7px}.slink{display:inline-flex;align-items:center;gap:5px;padding:5px 12px;background:#f8fafc;border:1px solid #e2e8f0;border-radius:5px;font-size:11px;color:#4f46e5;text-decoration:none;font-weight:500}.ebox{display:flex;flex-direction:column;gap:10px;background:#f8fafc;border:1px solid #e2e8f0;border-radius:10px;padding:16px 18px}.ebox p{font-size:12px;color:#334155}.ebox__block{font-size:12px;color:#334155}.ebox__text{white-space:pre-wrap;margin-top:6px;line-height:1.75}.blist{padding-left:18px;display:flex;flex-direction:column;gap:8px}.blist li{font-size:12px;color:#334155}.hlist{display:flex;flex-direction:column;gap:12px}.hcard{border:1px solid #e2e8f0;border-radius:10px;padding:14px 16px;background:#fff}.hcard__top{display:flex;justify-content:space-between;gap:10px;align-items:flex-start}.hcard__meta{display:block;font-size:10px;color:#94a3b8;margin-top:2px}.hcard__count{display:inline-flex;align-items:center;justify-content:center;min-width:28px;height:24px;padding:0 8px;border-radius:999px;background:#eef2ff;color:#4338ca;font-size:11px;font-weight:700}.hcard__summary{margin-top:8px;font-size:12px;color:#475569}.hcard__items{display:flex;flex-direction:column;gap:8px;margin-top:12px}.hcard__item{padding:10px 12px;background:#f8fafc;border-radius:8px;border:1px solid #e2e8f0}.hcard__item-top{display:flex;justify-content:space-between;gap:10px;font-size:11px;font-weight:700;color:#334155}.hcard__item-body{margin-top:4px;font-size:11px;color:#64748b}.hcard__impact{margin-top:6px;font-size:11px;color:#334155}.tlist{display:flex;flex-direction:column;gap:10px}.titem{padding:12px 14px;border:1px solid #e2e8f0;border-radius:10px;background:#fff}.titem__row{display:flex;justify-content:space-between;gap:12px;font-size:11px;color:#0f172a}.titem p{margin-top:6px;font-size:12px;color:#475569}.cbox{background:#fafbff;border-left:4px solid #4f46e5;padding:14px 18px;border-radius:0 7px 7px 0;font-size:12px;color:#374151;line-height:1.8;white-space:pre-wrap}.ftr{margin-top:32px;padding-top:10px;border-top:1px solid #e2e8f0;display:flex;justify-content:space-between;font-size:10px;color:#94a3b8}.ftr__id{font-family:monospace;font-size:9px}.print-btn{position:fixed;bottom:20px;right:20px;background:#4f46e5;color:#fff;border:none;padding:10px 22px;border-radius:7px;font-size:13px;font-weight:600;cursor:pointer;box-shadow:0 4px 18px rgba(79,70,229,.4);z-index:999}.print-btn:hover{background:#4338ca}.page-break{page-break-after:always;height:0;overflow:hidden}.batch-cover{display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:60vh;text-align:center;padding:80px 40px}.batch-cover__brand{font-size:28px;font-weight:800;color:#4f46e5;margin-bottom:4px}.batch-cover__title{font-size:16px;color:#64748b;margin-bottom:32px}.batch-cover__meta{font-size:12px;color:#94a3b8;line-height:2}.batch-sep{border:none;border-top:2px dashed #e2e8f0;margin:36px 0}@media print{body{background:#fff}.page{max-width:100%;padding:24px 28px;box-shadow:none}.print-btn{display:none}.sec{page-break-inside:avoid}.pr{page-break-inside:avoid}}@page{size:A4;margin:14mm 12mm}body::before{content:"CONFIDENCIAL";position:fixed;top:50%;left:50%;transform:translate(-50%,-50%) rotate(-45deg);z-index:9999;pointer-events:none;white-space:nowrap;font-size:86px;line-height:1;font-weight:900;letter-spacing:.12em;color:rgba(15,23,42,.04);text-transform:uppercase;user-select:none}@media screen and (max-width:720px){body{background:#fff;font-size:13px}.page{width:100%;max-width:none;padding:24px 18px 32px}.hdr{flex-direction:column;gap:10px}.hdr__right{text-align:left}.fgrid{grid-template-columns:1fr;gap:10px}.rbox{flex-direction:column;align-items:stretch;gap:16px;padding:16px}.rbox__div{width:100%;height:1px;margin:0}.rbox__bar{max-width:none}.pr__top,.hcard__top,.hcard__item-top,.titem__row,.ftr{flex-direction:column;align-items:flex-start}.slinks{flex-direction:column}.slink{width:100%;justify-content:center}body::before{font-size:48px;letter-spacing:.08em;color:rgba(15,23,42,.035)}}`;

function buildCaseReportHtml(caseData) {
    if (!caseData) return '';
...
<title>Relatório — ${esc(caseData.candidateName || 'Candidato')}</title>
<link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap" rel="stylesheet">
<style>${REPORT_CSS}</style></head><body>
<div class="page">${buildCaseBody(caseData, generatedAt)}</div>
<button class="print-btn" onclick="window.print()">🖨️ Imprimir / Salvar PDF</button>
</body></html>`;
}

module.exports = { buildCaseReportHtml, buildBatchReportHtml, REPORT_BUILD_VERSION };

function buildBatchReportHtml(cases, tenantName) {
