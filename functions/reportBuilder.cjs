...
function buildCaseBody(c, generatedAt) {
    ...
    const cpfStatusNorm = String(c.bigdatacorpCpfStatus || '').trim().toUpperCase();
    const identityAlerts = [];
    if (c.bigdatacorpHasDeathRecord === true) {
