...
const PRODUCT_REGISTRY = {
    ...
    kyc_individual: {
        ...
        requiredModules: ['identity_pf', 'criminal', 'warrants', 'kyc', 'decision', 'report_secure'],
    },
    kyb_business: {
        productKey: 'kyb_business',
        requiredModules: ['identity_pj', 'criminal', 'warrants', 'kyc', 'labor', 'decision', 'report_secure'],
    },
    kye_employee: {
        productKey: 'kye_employee',
        requiredModules: ['identity_pf', 'criminal', 'warrants', 'kyc', 'labor', 'decision', 'report_secure'],
    },
    kys_supplier: {
        productKey: 'kys_supplier',
        requiredModules: ['identity_pj', 'identity_pf', 'criminal', 'warrants', 'kyc', 'labor', 'decision', 'report_secure'],
    },
    tpr_third_party: {
