...
const PROVIDER_SOURCE_SPECS = [
    ...
    { provider: 'bigdatacorp', moduleKey: 'identity_pf', dataset: 'historical_basic_data', path: ['bigdatacorpSources', 'historicalBasicData'] },
    { provider: 'bigdatacorp', moduleKey: 'certidoes', dataset: 'financial_risk', path: ['bigdatacorpSources', 'financialRisk'] },
    { provider: 'bigdatacorp', moduleKey: 'certidoes', dataset: 'indebtedness_question', path: ['bigdatacorpSources', 'indebtedness'] },
    { provider: 'bigdatacorp', moduleKey: 'osint', dataset: 'media_profile_and_exposure', path: ['bigdatacorpSources', 'mediaProfile'] },
    { provider: 'bigdatacorp', moduleKey: 'judicial', dataset: 'lawsuits_distribution_data', path: ['bigdatacorpSources', 'lawsuitsDistribution'] },
    { provider: 'bigdatacorp', moduleKey: 'occupation', dataset: 'profession_data', path: ['bigdatacorpSources', 'occupation'] },
    // PJ datasets
    { provider: 'bigdatacorp', moduleKey: 'identity_pj', dataset: 'history_basic_data', path: ['bigdatacorpSources', 'historyBasicData'] },
    { provider: 'bigdatacorp', moduleKey: 'relationship', dataset: 'dynamic_qsa_data', path: ['bigdatacorpSources', 'dynamicQsa'] },
    { provider: 'bigdatacorp', moduleKey: 'judicial', dataset: 'owners_lawsuits', path: ['bigdatacorpSources', 'ownersLawsuits'] },
    { provider: 'bigdatacorp', moduleKey: 'kyc', dataset: 'employees_kyc', path: ['bigdatacorpSources', 'employeesKyc'] },
    { provider: 'bigdatacorp', moduleKey: 'kyc', dataset: 'economic_group_kyc', path: ['bigdatacorpSources', 'economicGroupKyc'] },
    { provider: 'bigdatacorp', moduleKey: 'esg', dataset: 'merchant_category_data', path: ['bigdatacorpSources', 'merchantCategory'] },
    { provider: 'bigdatacorp', moduleKey: 'esg', dataset: 'syndicate_agreements', path: ['bigdatacorpSources', 'syndicateAgreements'] },
    { provider: 'bigdatacorp', moduleKey: 'esg', dataset: 'social_conscience', path: ['bigdatacorpSources', 'socialConscience'] },
    { provider: 'bigdatacorp', moduleKey: 'osint', dataset: 'online_ads', path: ['bigdatacorpSources', 'onlineAds'] },
    { provider: 'bigdatacorp', moduleKey: 'certidoes', dataset: 'government_debtors', path: ['bigdatacorpSources', 'governmentDebtors'] },
    { provider: 'bigdatacorp', moduleKey: 'certidoes', dataset: 'collections', path: ['bigdatacorpSources', 'collections'] },
...
function buildProviderRequestsForCase({ caseId, caseData = {} } = {}) {
    ...
    const productKey = caseData.productKey || caseData.requestedProductKey || null;
    if (!productKey) {
        console.warn('[v2OperationalArtifactBuilder] Missing productKey for case', caseId);
    }
...
function buildRawSnapshotsForCase({ caseData = {}, providerRequests = [] } = {}) {
    return providerRequests
        .map((request) => {
