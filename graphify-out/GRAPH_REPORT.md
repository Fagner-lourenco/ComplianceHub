...
## Corpus Check
- 190 files · ~222,193 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1038 nodes · 1953 edges · 141 communities (136 shown, 5 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 182 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6ee41087`
...
Cohesion: 0.04
Nodes (49): applyCascadeReset(), applyDeleteFields(), assertCanAssignCase(), assertOpsManager(), buildExecutiveSummary(), buildExecutiveSummaryFallback(), buildExpandedKeyFindings(), buildKeyFindings() (+41 more)
...
Cohesion: 0.13
Nodes (29): acquireAutoClassifyRun(), applyAiClassificationReviewGuardrails(), buildAiClassificationReviewUpdatePayload(), buildAiHomonymPrompt(), buildAiHomonymResetPayload(), buildAiHomonymUpdatePayload(), buildAiPrefillUpdatePayload(), buildAiPrompt() (+21 more)
...
Cohesion: 0.11
Nodes (22): asDate(), buildAiPrefillPrompt(), buildCanonicalReportHtml(), buildProcessHighlights(), buildReportSlug(), buildSanitizedPublicResultSnapshot(), buildSourceSummary(), buildStatusSummary() (+14 more)

### Community 13 - "Community 13"
Cohesion: 0.14
Nodes (21): buildNextSteps(), buildResetPublishedCaseFields(), buildReviewDraftSeed(), extractFallbackAiClassificationReviewResponse(), hasMeaningfulValue(), looksLikeRawJsonOrTechnicalPayload(), normalizeKeyFindingsValue(), normalizeNarrativeValue() (+13 more)
...
Cohesion: 0.13
Nodes (16): applyAxisReviewGuardrail(), buildAiClassificationReviewContext(), buildAiClassificationReviewPrompt(), buildAxisReviewContext(), buildReviewSource(), compactBigDataCorpProcessos(), compactDjenComunicacoes(), compactEscavadorProcessos() (+8 more)
...
Cohesion: 0.24
Nodes (4): TenantProbe(), useTenant(), ClientesPage(), FilaPage()
...
- **Why does `buildCaseReportHtml()` connect `Community 5` to `Community 34`, `Community 35`, `Community 12`?**
  _High betweenness centrality (0.344) - this node is a cross-community bridge._
- **Why does `buildCanonicalReportHtml()` connect `Community 12` to `Community 1`, `Community 5`?**
  _High betweenness centrality (0.339) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 0` to `Community 33`, `Community 34`, `Community 2`, `Community 36`, `Community 5`, `Community 6`, `Community 41`, `Community 14`, `Community 16`, `Community 20`, `Community 22`, `Community 23`, `Community 25`, `Community 28`?**
