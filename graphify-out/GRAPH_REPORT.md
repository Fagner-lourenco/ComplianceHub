...
Cohesion: 0.1
Nodes (22): ClientReportPage(), shortToken(), callBackendFunction(), callCancelExportJob(), callConcludeCaseByAnalyst(), callCreateExportJob(), callGetClientCaseById(), callGetExportJobStatus() (+14 more)
...
Cohesion: 0.12
Nodes (8): buildPrintableHtml(), esc(), ExportacoesPage(), normalizeJobStatus(), getMockExports(), callGetClientExportCases(), callRegisterClientExport(), asyncPool()
...
- **Why does `buildCaseReportHtml()` connect `Community 17` to `Community 24`, `Community 0`, `Community 14`?**
  _High betweenness centrality (0.247) - this node is a cross-community bridge._
- **Why does `buildCanonicalReportHtml()` connect `Community 0` to `Community 17`?**
