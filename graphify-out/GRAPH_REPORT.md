...
## Corpus Check
- 280 files · ~374,501 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1699 nodes · 3170 edges · 74 communities detected
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 385 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ccb9052d`
...
Cohesion: 0.06
Nodes (42): buildClientCasePayload(), clientPayloadChanged(), enforceTenantSubmissionLimits(), formatDateKey(), formatMonthKey(), getClientQuotaStatusInner(), getClientUserProfile(), revokeCasePublicationArtifacts() (+34 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (48): canBypassIdentityGate(), isIdentityGateBlocked(), hasBenignNoProcessCoverage(), isFirestoreSentinel(), sanitizeAuditMetadataValue(), sanitizePublicStructuredValue(), sanitizeStructuredText(), buildConcludeUpdatePayload() (+40 more)

### Community 5 - "Community 5"
Cohesion: 0.07
Nodes (54): ClientReportPage(), shortToken(), buildTenantStructuredQuery(), callBackendFunction(), callConcludeCaseByAnalyst(), callGetClientCaseById(), callListOpsCases(), callRerunAiAnalysis() (+46 more)
...
Cohesion: 0.07
Nodes (30): badge(), buildBatchReportHtml(), buildCaseBody(), buildCaseReportHtml(), esc(), fieldHtml(), flagColor(), formatBirthAndAge() (+22 more)
...
Cohesion: 0.09
Nodes (35): attemptJsonRepair(), fixLatinMojibake(), isStringArray(), looksLikeRawJsonOrTechnicalPayload(), normalizeUnicodeToAscii(), parseAiClassificationReviewResponse(), parseAiHomonymResponse(), parseAiPrefillResponse() (+27 more)
...
Cohesion: 0.1
Nodes (19): AuthProvider(), AuthProbe(), useAuth(), DemoProviders(), callGetSystemHealth(), Sidebar(), NotificationProvider(), SaudePage() (+11 more)
...
Cohesion: 0.09
Nodes (15): TenantProbe(), useTenant(), getCaseStats(), callAssignCaseToAnalyst(), callAssignCaseToCurrentAnalyst(), callCreateOpsClientUser(), callCreateOpsUser(), callListOpsUsers() (+7 more)
...
Cohesion: 0.11
Nodes (14): maskCpf(), NovaSolicitacaoPanel(), validateCpf(), validateUrl(), callCreateClientSolicitation(), callUpdateTenantSettingsByAnalyst(), getEnabledPhases(), getTenantSettings() (+6 more)
...
Cohesion: 0.11
Nodes (13): CaseCommunicationPanel(), formatMessageDate(), getReportStatus(), isReportAvailable(), RelatoriosClientePage(), formatDate(), formatDateTimeBR(), toDate() (+5 more)

### Community 26 - "Community 26"
Cohesion: 0.14
Nodes (12): DashboardClientePage(), getMacroProgress(), hasAnySocialProfile(), hasMeaningfulSocialAnalysis(), SolicitacoesPage(), callGetClientDashboardMetrics(), callGetClientQuotaStatus(), callListClientCases() (+4 more)
...
Cohesion: 0.13
Nodes (19): buildAiPrefillPrompt(), buildCanonicalReportHtml(), buildNextSteps(), buildProcessHighlights(), buildReportSlug(), buildSanitizedPublicResultSnapshot(), buildSourceSummary(), buildStatusSummary() (+11 more)
...
Cohesion: 0.18
Nodes (17): buildResetPublishedCaseFields(), buildReviewDraftSeed(), extractFallbackAiClassificationReviewResponse(), looksLikeRawJsonOrTechnicalPayload(), normalizeKeyFindingsValue(), normalizeNarrativeValue(), pickConcludePayload(), pickDraftPayload() (+9 more)
...
- **Why does `buildCaseReportHtml()` connect `Community 7` to `Community 28`, `Community 5`?**
  _High betweenness centrality (0.280) - this node is a cross-community bridge._
- **Why does `buildCanonicalReportHtml()` connect `Community 28` to `Community 0`, `Community 7`?**
  _High betweenness centrality (0.254) - this node is a cross-community bridge._
- **Why does `extractErrorMessage()` connect `Community 24` to `Community 35`, `Community 5`, `Community 41`, `Community 42`, `Community 13`, `Community 15`, `Community 16`, `Community 19`, `Community 20`, `Community 21`, `Community 25`, `Community 26`?**
